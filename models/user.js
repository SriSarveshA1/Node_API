...
const userSchema=new mongoose.Schema({
    ...
    updated: {  //updated dat
        type:Date,
        default:Date.now//by default we use to get the current date using Date.now
    }
 ...
 userSchema.virtual(password).set(function(v){
   ...
   this.hashed_password=this.encrypted_password(password);//this encrypted_password() method is also from the userschema object that takes the plane password and converts it and sends the encrypted password
 })
 .get(function(){
